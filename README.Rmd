...
[![cran checks](https://badges.cranchecks.info/worst/ritalic.svg)](https://cran.r-project.org/web/checks/check_results_ritalic.html)
[![rstudio mirror downloads](https://cranlogs.r-pkg.org/badges/ritalic)](https://github.com/r-hub/cranlogs.app)
[![cran version](https://www.r-pkg.org/badges/version/ritalic)](https://cran.r-project.org/package=ritalic)
<!-- badges: end -->

**ritalic** is an R package which gives you access to [ITALIC](https://italic.units.it/) mediated data via its [RESTful API](https://italic.units.it/index.php?procedure=api).

**ITALIC** the Information System on Italian Lichens, makes available
information and resources about the lichens known to occur in Italy and bordering countries. It
...
Italic has a guide designed to help users: [function and examples](https://italic.units.it/ritalic-basic/)
