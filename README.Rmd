...
The package includes a vignette designed to help users. This vignette serves as a basic guide for utilizing the main functions of the package. To access it, simply enter the following command in the R console (after loading the package):
